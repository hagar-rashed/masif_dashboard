                                                    ...
                                                    <div class="btn-group" role="group" aria-label="Second group">
                                                        ...
                                                        {{-- <a href="{{ route('destroyTrip', $trip->id) }}"
                                                            ...
                                                            class="btn btn-sm btn-danger item-delete"><i
                                                                ...
                                                                <form id="delete-form-{{ $trip->id }}" action="{{ route('destroyTrip', $trip->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <a href="#" class="btn btn-sm btn-danger item-delete" data-id="{{ $trip->id }}"
                                                                       onclick="event.preventDefault(); document.getElementById('delete-form-{{ $trip->id }}').submit();">
