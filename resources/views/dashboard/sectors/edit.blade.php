                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ $sector->name }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ $sector->name }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="updatesectorForm"
                                        action="{{ route('admin.sectors.update', $sector->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group prev">
                                                    <img src="{{ asset('storage/' . $sector->image) }}" style="width: 100px"
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="desc_ar" rows="10">{{ old('desc_ar', $sector->desc_ar) }}</textarea>
                                                    @error('desc_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="desc_en" rows="10">{{ old('desc_en', $sector->desc_en) }}</textarea>
                                                    @error('desc_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
