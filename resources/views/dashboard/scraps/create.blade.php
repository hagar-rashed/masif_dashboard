...
@section('title', __('models.add_n_scrap'))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.add_n_scrap') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.add_n_scrap') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="createScrapForm"
                                        action="{{ route('admin.scraps.store') }}" method="POST"
