...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        ...
        {{-- QR Code--}}
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="nav-item {{ areActiveRoutes(['admin.qrcodes.index', 'admin.qrcodes.create', 'admin.qrcodes.edit']) }}">
           <a class="d-flex align-items-center" href="{{ route('admin.qrcodes.index') }}">
            <i class="fa-solid fa-qrcode"></i><span class="menu-title text-truncate">{{ __('models.qrcodes') }}</span>
           </a>
          </li>
        </ul>
