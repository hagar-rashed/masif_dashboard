                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.talks.index') }}">{{ __('models.talk') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.add') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="createTalkForm"
                                        action="{{ route('admin.talks.store') }}" method="POST"
