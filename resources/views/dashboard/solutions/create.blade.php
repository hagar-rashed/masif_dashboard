...
@section('title', __('models.add_n_solution'))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.add_n_solution') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.add_n_solution') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="createsolutionForm"
                                        action="{{ route('admin.solutions.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control image" accept="image/*"
